...
frame_alpr = tk.LabelFrame(root, text=" --Process-- ", width=220, height=550, bd=5, font=('times', 14, ' bold '),bg="tomato")
...
def dec():
    ...
    background_label = tk.Label(newWindow, image=background_image)

    background_label.image = background_image

    background_label.place(x=0, y=0) #, relwidth=1, relheight=1)
    # #
    lbl = tk.Label(newWindow, text="______DECODE_____", font=('times', 35,' bold '), height=1, width=60,bg="brown",fg="white")
    lbl.place(x=0, y=0)
    ...
    # l6 = tk.Label(newWindow, text=decoded_data, width=60, font=("Times new roman", 15, "bold"), bg="snow")
    ...
    imgtk1 = ImageTk.PhotoImage(im1)
    img1 = tk.Label(newWindow, image=imgtk1, height=250, width=250)
    img1.image = imgtk1
    ...
    imgtk1 = ImageTk.PhotoImage(im1)
    img2 = tk.Label(newWindow, image=imgtk1, height=250, width=250)
    img2.image = imgtk1
    img2.place(x=600, y=400)
    ...
    imgtk2 = ImageTk.PhotoImage(im2)
    img2 = tk.Label(newWindow, image=imgtk2, height=250, width=250)
    img2.image = imgtk2
...
def de():
    def en():
        ...
        call(["python", "steganopraphy.py"])  


button1 = tk.Button(frame_alpr, text="Stegno Image ", command=uploadi,width=15, height=1, font=('times', 15, ' bold '),bg="white",fg="black")
button1.place(x=10, y=50)

button2 = tk.Button(frame_alpr, text="1st Image", command=hide1, width=15, height=1, font=('times', 15, ' bold '),bg="white",fg="black")
...
#
button4 = tk.Button(frame_alpr, text="2nd Image", command=hide2,width=15, height=1,bg="white",fg="black", font=('times', 15, ' bold '))
button4.place(x=10, y=150)
#

button5 = tk.Button(frame_alpr, text="3rd Image", command=hide3,width=15, height=1, font=('times', 15, ' bold '),bg="white",fg="black")
button5.place(x=10, y=200)

button5 = tk.Button(frame_alpr, text="Encode", command=sub,width=15, height=1, font=('times', 15, ' bold '),bg="yellow4",fg="white")
button5.place(x=10, y=250)

button5 = tk.Button(frame_alpr, text="Decode", command=dec,width=15, height=1, font=('times', 15, ' bold '),bg="yellow4",fg="white")
